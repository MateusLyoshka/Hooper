              ...
              <CardContent>
                {yourgames.map((itens, index) => (
                  <Link key={index} href={`/home/yourmatches/${itens.id}`}>
                    <div className="mt-2">
                      Game {index + 1}: Time {itens.teamA} vs Time {itens.teamB}{" "}
                      - {itens.type}, {itens.day}/{itens.mounth}/{itens.year}{" "}
                      {itens.time}, {itens.mode}, {itens.court}.{" "}
                    </div>
                  </Link>
                ))}
              </CardContent>
